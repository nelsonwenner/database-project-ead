...
BEGIN
	...
	IF COD_PROFESSOR IS NOT NULL THEN
		...
		PRECO, DEFAULT, DEFAULT, DEFAULT, DEFAULT, COD_PROFESSOR);
	ELSE
...
CREATE OR REPLACE FUNCTION EVENTO_VALIDAR_CURSO()
RETURNS TRIGGER
AS $$
DECLARE
...
CREATE TRIGGER EVENTO_ANALISA_DISPONIBILIDADE
AFTER INSERT OR DELETE ON VIDEO_AULA
FOR EACH ROW
EXECUTE PROCEDURE EVENTO_VALIDAR_CURSO();
...
SELECT FROM DELETAR_VIDEO('12345', 1, 3, 9, 36)
